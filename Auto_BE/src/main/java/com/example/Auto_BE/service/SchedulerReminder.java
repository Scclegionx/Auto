...
//    }
//
//    // Thêm method này vào SchedulerReminder class
//    public void scheduleImmediatelyForNewReminder(Long medicationReminderId) {
//        try {
//            MedicationReminder reminder = medicationReminderRepository.findById(medicationReminderId)
//                    .orElseThrow(() -> new RuntimeException("Medication reminder not found"));
//
//            // Validate reminder data
//            if (reminder.getType() == null || reminder.getDaysOfWeek() == null ||
//                    reminder.getReminderTime() == null || reminder.getDaysOfWeek().trim().isEmpty() ||
//                    reminder.getReminderTime().trim().isEmpty()) {
//                return;
//            }
//
//            LocalDate today = LocalDate.now();
//            LocalDate endOfWeek = today.plusDays(7);
//
//            System.out.println("=== Scheduling immediately for new reminder ===");
//            System.out.println("Reminder: " + reminder.getName() + " (ID: " + reminder.getId() + ")");
//            System.out.println("Period: " + today + " to " + endOfWeek);
//
//            int scheduled = scheduleReminderForWeek(reminder, today, endOfWeek);
//
//            System.out.println("Immediately scheduled " + scheduled + " notifications");
//            System.out.println("=== Finished immediate scheduling ===");
//
//        } catch (Exception e) {
//            System.err.println("ERROR in scheduleImmediatelyForNewReminder: " + e.getMessage());
//            e.printStackTrace();
//        }
//    }
//
